  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url(/assets/2fe29e3f61a6e53093c503c181238cdc.jpg)' }}
      />
      ...
      <div className="absolute top-10 left-10 heart-float opacity-20 z-10">
        <Heart className="w-12 h-12 text-primary fill-primary" />
      </div>
      <div className="absolute top-32 right-16 heart-float opacity-15 z-10" style={{ animationDelay: '1s' }}>
        <Heart className="w-16 h-16 text-accent fill-accent" />
      </div>
      <div className="absolute bottom-40 left-1/4 heart-float opacity-20 z-10" style={{ animationDelay: '2s' }}>
        <Heart className="w-10 h-10 text-primary fill-primary" />
      </div>
      <div className="absolute bottom-20 right-1/3 heart-float opacity-15 z-10" style={{ animationDelay: '1.5s' }}>
        <Heart className="w-14 h-14 text-accent fill-accent" />
      </div>
      <div className="absolute top-1/2 left-12 heart-float opacity-10 z-10" style={{ animationDelay: '0.5s' }}>
        <Heart className="w-8 h-8 text-primary fill-primary" />
      </div>
      <div className="absolute top-1/3 right-12 heart-float opacity-15 z-10" style={{ animationDelay: '2.5s' }}>
      ...
      <main className="relative z-20 flex-1 flex items-center justify-center p-4 sm:p-6 md:p-8">
        <div className="max-w-3xl w-full text-center space-y-8 md:space-y-12">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-tight drop-shadow-lg">
          ...
          {/* Signature */}
          <div className="pt-6">
            <p className="text-xl md:text-2xl font-display italic text-foreground/90 drop-shadow">
              Forever yours,
            </p>
